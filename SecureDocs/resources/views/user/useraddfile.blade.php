                    ...
                    <div>
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            <div class="mx-auto w-full max-w-[2000] bg-white">
                                <form class="py-6 px-9" action="{{ route('insertfiletable') }}" method="post"
                                    enctype="multipart/form-data">
                                    @csrf

                                    <div class="grid gap-2 mb-6 md:grid-cols-3 border-b">
                                        <div class="mb-5">
                                            @php
                                            $user = Auth::user()->name
                                            @endphp
                                    ...
                                    <div class="grid gap-3 mb-6 md:grid-cols-2 border-b">
                                        <div class="mb-5">
                                            <label for="email" class="mb-3 block text-base font-medium text-[#07074D]">
                                                File ID
                                            </label>
                                            <div>
                                                ...
                                                <input type="number" name="file_idID" id="file_idID"
                                                    placeholder="File ID"
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid gap-3 mb-6 md:grid-cols-3 border-b">
                                        <div class="mb-5">
                                            ...
                                            <div>
                                                ...
                                                <input oninput="this.value = this.value.toUpperCase()" type="text"
                                                    name="file_name" id="file_name" placeholder="File name"
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-5">
                                                <div>
                                                    ...
                                                    <input oninput="this.value = this.value.toUpperCase()" type="text"
                                                        ...
                                                        placeholder="File docket number"
                                                        class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid gap-3 mb-6 md:grid-cols-4 border-b">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input
                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                                                type="text" name="file_client" id="file_client"
                                                value="{{ $clientData->client_id ?? 'No data available'}}"
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" name="client_fname" id="client_fname"
                                                ...
                                                placeholder="First name" read only
                                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                        </div>
                                ...
                                <script>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div>
                                                <x-input-error :messages="$errors->get('b_clientbalance')"
                                                    class="mt-2" />
                                                <input type="number" name="b_clientbalance" id="b_clientbalance"
                                                    value="NULL" placeholder="Balance"
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">
                                                <div class="mb-5">
                                    ...
                                    <div class="grid gap-3 mb-6 md:grid-cols-1 border-b">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div>
                                                <x-input-error :messages="$errors->get('file_casetypetype')"
                                                    class="mt-2" />
                                                <input oninput="this.value = this.value.toUpperCase()" type="text"
                                                    name="file_casetypetype" id="file_casetypetype"
                                                    placeholder="{{ $data->file_casetypetype ?? 'No data available'}}"
                                                    class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                            </div>
                                        </div>
                                        <!--fle case type checkox end -->
                                        <div class="grid gap-1 mb-1 md:grid-cols-3 border-b">
                                            <div class="mb-5">
                                                <label for="email"
                                                    class="mb-3 block text-base font-medium text-[#07074D]">
                                                    Payment Status:
                                                ...
                                                <div>
                                                    <x-input-error :messages="$errors->get('b_paymethod')"
                                                        class="mt-2" />
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <div>
                                                    <x-input-error :messages="$errors->get('file_branch')"
                                                        class="mt-2" />
                                                    <input oninput="this.value = this.value.toUpperCase()" type="text"
                                                        name="file_branch" id="file_branch" placeholder="File Branch"
                                                        class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                </div>
                                            </div>
                                            <div class="mb-5">
                                                ...
                                                <div>
                                                    <x-input-error :messages="$errors->get('file_court')"
                                                        class="mt-2" />
                                                    <input oninput="this.value = this.value.toUpperCase()" type="text"
                                                        name="file_court" id="file_court" placeholder="File Court"
                                                        class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-8">
                                                <div>
                                                    ...
                                                    <label class="block">
                                                        ...
                                                        <input name="file" id="fileupload" type="file" class="block w-full text-sm text-gray-500 font-semibold
                                                        file:mr-3 file:py-3 file:px-7
                                                        file:rounded-md file:border-0
                                                        file:text-base file:font-semibold bg-gray-50 rounded-md border-b
                                                        file:bg-[#6A64F1] file:text-white
                                                        ...
                                                        <div class="py-5">
                                                            <button type="submit"
                                                                onclick="return confirm('Continue adding this file?')"
