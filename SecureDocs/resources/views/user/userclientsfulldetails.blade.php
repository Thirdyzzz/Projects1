                        ...
                        <div class="bg-white dark:bg-white-100 overflow-hidden shadow-sm sm:rounded-lg">       
                            ...
                            <div>
                                ...
                                <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 space-y-1 p-4 border-b">
                                    ...
                                    <p></p>     
                                        <a class="text-blue-500" href="{{ route('viewhistory', ['id' => $dataFromVerifyMethod->client_id]) }}">View unpaid history</a>
                                    <p></p>     
                                        <a class="text-blue-500" href="{{ route('archivedhistory', ['id' => $dataFromVerifyMethod->client_id]) }}">View paid history</a>                                
                                    <p></p>
                                    <!-- <a class="text-blue-500" href="{{ route('billing', ['id' => $dataFromVerifyMethod->client_id]) }}">Add new balance</a> -->
                                ...
                                <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 space-y-1 p-4 border-b">
                                    ...
                                    <p></p>     
                                    <!-- <a class="text-blue-500" href="{{ route('viewhistory', ['id' => $dataFromVerifyMethod->client_id]) }}">Add case for client</a>                             -->
                                    <p></p>
                                ...
                                <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 space-y-1 p-4">
                                    ...
                                    <p>
                                    <a class="text-blue-500" href="{{ route('registerclientview', ['id' => $dataFromVerifyMethod->client_id]) }}">Create client account</a>
                                    <p>
                                        
                                    </p>
                                    <a class="text-blue-500" href="{{ route('editclientview', ['id' => $dataFromVerifyMethod->client_id]) }}">Edit client account</a>
                                    </p>                                
                                    </p>                                    
                                    </p>
                                    </p>
                                    <p></p>  
                                    <a class="text-blue-500" href="{{ route('useraddfile', ['id' => $dataFromVerifyMethod->client_id]) }}">Add case</a>
                                    </p>
                                </div>       
                            </div>
                        </div>
