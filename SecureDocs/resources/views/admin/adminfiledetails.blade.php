        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div>
                        <form action="{{route('adminfiletable')}}">
                            <!-- component -->
                                ...
                                <tbody id="tableBody" class="text-sm font-normal text-gray-700">
                                    <tr class="hover:bg-gray-100 border-b border-gray-200 py-10">
                                        ...
                                        <td class="px-4 py-4 flex"><a
                                            ...
                                            <a class="text-blue-500" onclick="return confirm('Edit this file?')"
                                            ...
                                            <a class="text-blue-500"
                                                onclick="return confirm('Do you want to archive this file?')" href="{{ route('setasarchive', [
                                            'file_id' => $row->file_id,
                        ...
                        <div class="mt-4 p-4 sticky bottom-0 bg-white">
                            ...
                            'date_from' => request('date_from'), 'date_to' => request('date_to'), 'sort_by' =>
                            request('sort_by'), 'order' =>
                            request('order')])->links() }}
                        </div>
                    </div>
