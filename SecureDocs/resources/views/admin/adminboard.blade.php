    ...
    <div class="py-12">
        <div class="max-w-7xl  mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="grid grid-cols-12 gap-10 px-10">
                            <div class="col-span-12 sm:col-span-6 md:col-span-3">
                                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                                    ...
                                    <div class="flex flex-col flex-grow ml-4">
                                        ...
                                        <div class="font-bold text-lg text-black">{{$data}}</div>
                                    </div>
                            ...
                            <div class="col-span-12 sm:col-span-6 md:col-span-3">
                                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                                    ...
                                    <div class="flex flex-col flex-grow ml-4">
                                        ...
                                        <div class="font-bold text-lg text-black">{{$client}}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-span-12 sm:col-span-6 md:col-span-3">
                                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                                    ...
                                    <div class="flex flex-col flex-grow ml-4">
                                        <div class="text-sm text-gray-5500">Users</div>
                                        <div class="font-bold text-lg text-black">{{$user}}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-12 sm:col-span-6 md:col-span-3">
                ...
                <div class="flex">
                    ...
                    <div class="w-1/3 p-6">
                        ...
                        <div class="bg-white rounded-lg p-4 mb-4 w-7x1">
                            <!-- Card 1 Content -->
                            <lable for="myDonutChart" class="font-bold mb-4"> Case Type
                            </lable>
                            <div class=" mx-auto">
                    ...
                    <div class="w-1/3 p-6">
                        ...
                        <div class="bg-white rounded-lg p-4 mb-4 w-full">
                            <!-- Card 1 Content -->
                            <lable for="myDonutChart" class="font-bold mb-4"> Case Status
                            </lable>
                            <div class=" mx-auto">
                    ...
                    <div class="w-1/3 p-6">
                        ...
                        <div class="bg-white rounded-lg p-4 mb-4 w-full">
                            <!-- Card 1 Content -->
                            <lable for="myDonutChart" class="font-bold mb-4"> Users
                            </lable>
                            <div class=" mx-auto">
                            ...
                            <script>
                                document.addEventListener('DOMContentLoaded', function () {
                                        ...
                                        var myDonutChart = new Chart(ctx, {
                                            type: 'doughnut',
                                            data: {
                                                labels: @json($chartDataUsers['labels']),
                                                datasets: [{
                                                    data: @json($chartDataUsers['data']),
                                                    backgroundColor: [
            ...
            <div class="flex-1 bg-white rounded-lg  mt-4 p-8">
                ...
                <div class="mt-4 py-4 sticky bottom-0 bg-white">
                    {{ $recents->appends(['date_from' => request('date_from'), 'date_to' => request('date_to'), 'sort'
