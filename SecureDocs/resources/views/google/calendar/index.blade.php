                ...
                <div class="p-6">
                    <div class="p-4 w-full">
                        <div class="grid grid-cols-12 gap-10 px-10">
                            ...
                            <div class="col-span-12 sm:col-span-6 md:col-span-0">
                                <div class="flex flex-row bg-white shadow-sm rounded p-4">
                                    ...
                                    <div class="flex flex-col flex-grow ml-1">
                                    <div class="text-sm text-gray-500">Gmail logged in 
                                    @foreach ($events->getItems() as $event)
                                        <p class="text-sm text-red hidden">{{ $event->getSummary() }} - {{ $event->getDescription() }} - {{ $event->getStart()->getDateTime() }}</p>
                                    @endforeach
                                    </div>
                                    <div class="font-bold text-lg text-black"><h1>You are logged in!</h1>
                                    </div>
                                </div>
                            </div>
