        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div>
                        <form action="{{route('clientall', ["client_id" => $data->client_id])}}">
                            <!-- component -->
                            <div class="bg-white pb-4 px-4 rounded-md w-full">
                                <h2 class=" font-bold">Client {{$data->client_id}}: {{$data->client_fname}}
                                    {{$data->client_mname}} {{$data->client_sname}} case files.</h2>
                                    ...
                                    <tr class="hover:bg-gray-100 border-b border-gray-200 py-10">
                                        ...
                                        <td class="px-4 py-4 flex"><a
                                            ...
                                            <a class="text-blue-500"
                                                href="{{ route('fileupdateview', ['id' => $row->file_id, 'file_client' => $row->file_client, 'file_idID'=> $row->file_idID]) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        ]) }}" onclick="return confirm('Continue archiving this file?')">
                                            ...
                                            <a class="text-blue-500"
                                                onclick="return confirm('Generate report slip for clients cases?') "
                                                class="text-blue-500"
                                                href=" {{ route('printview', ['client_id' => $data->client_id]) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
